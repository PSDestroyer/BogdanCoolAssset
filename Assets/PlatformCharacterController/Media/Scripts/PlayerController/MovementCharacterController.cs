...
{
    public class MovementCharacterController : MonoBehaviour, ICharacter
    {
        ...
        #region New Input Actions

        public void FlyJetPack(InputAction.CallbackContext context)
        {
            _flyJetPack = context.performed;
        }
        ...
        public bool GiveItem(ICharacter to, ItemData data)
        {
        ...
        public void Initialize()
        {
            ...
            _inventory.Initialize(this, default_items);
